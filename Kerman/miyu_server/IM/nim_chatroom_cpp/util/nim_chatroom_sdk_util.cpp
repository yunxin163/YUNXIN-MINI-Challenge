...
std::map<std::string, void*> SDKInstance::function_map;
std::function<void*(const std::string&)> SDKInstance::get_proc_address_wrapper_ = [](const std::string&)->void* {return nullptr;};
