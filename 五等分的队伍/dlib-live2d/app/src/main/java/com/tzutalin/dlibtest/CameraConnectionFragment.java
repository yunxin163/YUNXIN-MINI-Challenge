...
public class CameraConnectionFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        mySurfaceView = new MySurfaceView(getContext());
    ...
    public void onViewCreated(final View view, final Bundle savedInstanceState) {
        ...
        layout = view.findViewById(R.id.view_layout);
            ...
            for (final String cameraId : manager.getCameraIdList()) {
                ...
                if (facing != null && facing == CameraCharacteristics.LENS_FACING_BACK) {
                    if (cameraFaceTypeMap.get(CameraCharacteristics.LENS_FACING_BACK) != null) {
                        cameraFaceTypeMap.append(CameraCharacteristics.LENS_FACING_BACK, cameraFaceTypeMap.get(CameraCharacteristics.LENS_FACING_FRONT) + 1);
                    } else {
                ...
                if (facing != null && facing == CameraCharacteristics.LENS_FACING_FRONT) {
                    if (cameraFaceTypeMap.get(CameraCharacteristics.LENS_FACING_BACK) != null) {
                        cameraFaceTypeMap.append(CameraCharacteristics.LENS_FACING_FRONT, cameraFaceTypeMap.get(CameraCharacteristics.LENS_FACING_BACK) + 1);
                    } else {
    ...
    private void createCameraPreviewSession() {
        ...
        mOnGetPreviewListener.initialize(getActivity().getApplicationContext(), getActivity().getAssets(),
                mScoreView, inferenceHandler,mySurfaceView.getRenderer());
    }
