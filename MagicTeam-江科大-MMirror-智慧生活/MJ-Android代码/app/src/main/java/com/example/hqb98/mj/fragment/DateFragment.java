...
public class DateFragment extends LazyFragment implements View.OnClickListener {
    ...
    public  void requestData() {
        ...
        HttpUtil.getDateRequest(userid, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (null!=dateHttps.get(0)&&dateHttps.size()!=0){
                    ...
                    EventBus.getDefault().post(new EventMesage(1) );
                }
    ...
    public void deleteDate(EventMesage mesage){
        switch (mesage.getNum()){
            ...
            case 3:
                ...
                EventBus.getDefault().post(new EventMesage(1));
                viewPager.setCurrentItem(mesage.getIndex_fragment());
                break;
        }
    }
