...
public class CreatDate extends BaseActivity implements View.OnClickListener{
...
//                                date_time.append(getMonth()).append(".").append(getDay()).append(" ").append(week).append(" ").append(getHour()).append(":").append(getMinute());
                                    ...
                                    date.save();
                                    DateFragment.dateList.add(0, date);
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(CreatDate.this,"网络出现了一点小问题哦！",Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
