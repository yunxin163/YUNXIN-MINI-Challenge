...
class Main extends Component {
  ...
  switchVideo(e){
    console.log(`switchVideo`,e.target);
    console.log(e.target.parentNode.parentNode.id);
    let vid=e.target.parentNode.parentNode.id;
    if(vid==='video-2'){
      console.log(`video-2`);
      console.log(document.getElementsByClassName('m-netcall-video video-1')[0]);
      document.getElementsByClassName('m-netcall-video video-1')[0].setAttribute('class','m-netcall-video video-2');
      console.log(document.getElementById('video-2'));
      document.getElementById('video-2').setAttribute('id','video-1');
      document.getElementsByClassName('m-netcall-video video-2')[1].setAttribute('class','m-netcall-video video-1');
      document.getElementById('video-1').setAttribute('id','video-2');
      clickTime++;
    }
    if(vid==='video-1'&&clickTime>0){
      console.log(`video-1`);
      console.log(document.getElementsByClassName('m-netcall-video video-12')[0]);
      document.getElementsByClassName('m-netcall-video video-2')[0].setAttribute('class','m-netcall-video video-1');
      console.log(document.getElementById('video-1'));
      document.getElementById('video-1').setAttribute('id','video-2');
      document.getElementsByClassName('m-netcall-video video-1')[1].setAttribute('class','m-netcall-video video-2');
      document.getElementById('video-2').setAttribute('id','video-1');
    }
  };
    ...
    return (
      <div>
        ...
        <div className="m-main">
          ...
          <Whiteboard />
          <div className="m-netcall" onClick={this.switchVideo}>
            {NetcallState.members.slice(0,2).map((item, index) => (
              <Video
                key={index}
